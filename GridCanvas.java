...
public class GridCanvas extends Canvas {
    ...
    /**
     * countOn method counts the total number o cells that are turned on.
     */
     public int countOn(){
    
        int count = 0;
        for (Cell[] array1 : array) {
     ...
     * doesn't exist or is off. Implements toroidal wrapping - coordinates
     * wrap around to the opposite side if they are out of bounds.
     * 
     * @param r row index
     * @param c column index
     * @return 1 or 0
